...
/**
  ******************************************************************************
  * @file           : L1178_findNumOfValidWords.cpp.cc
  * @author         : garen_lee
  * @brief          : None
  * @attention      : None
  * @date           : 2025/6/26
...
#include "L1178_findNumOfValidWords.h"

vector<int> L1178_findNumOfValidWords::findNumOfValidWords(vector<string> &words, vector<string> &puzzles) {
...
void L1178_findNumOfValidWords::test() {
